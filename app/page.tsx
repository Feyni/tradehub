    ...
    <main className="flex min-h-screen flex-col bg-black p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row ">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <Image src="/hero-desktop.png" width={1000} height={686} className='hidden md:block' alt="Desktop App Logo" />
          <Image src="/hero-mobile.png" width={560} height={620} className='hidden md:block' alt="Mobile App Logo" />
        </div>
      </div>
    </main>
  );
